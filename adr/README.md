...
See [template.md](template.md) for a copy-paste template.
...
| ADR | Title | Purpose |
|-----|-------|---------|
| [0001](0001-frontend-stack.md) | Frontend Stack | Why React + Vite + TypeScript |
| [0002](0002-backend-stack.md) | Backend Stack | Why Node + Express + SQLite |
| [0003](0003-diagram-conventions.md) | Diagram Conventions | Why Mermaid and specific notation |
...
- [template.md](template.md) — Copy-paste ADR template
- [docs/mental-models/architecture-first.md](../docs/mental-models/architecture-first.md) — Using ADRs with LLMs
- [curriculum/part-2-team-practices/08-adrs.md](../curriculum/part-2-team-practices/08-adrs.md) — Learning module
