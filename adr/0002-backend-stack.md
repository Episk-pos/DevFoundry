...
- [ADR-0001: Frontend Stack](0001-frontend-stack.md) — Node aligns with JavaScript ecosystem
- [ADR-0004: Database Choice for Learning](0004-database-choice.md) — (future) Deep dive on SQLite vs others
- [ADR-0005: Deployment Platform](0005-deployment-platform.md) — (future) Where to host Node + SQLite
