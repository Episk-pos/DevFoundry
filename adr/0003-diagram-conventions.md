...
### Documentation
- [docs/diagram-standards.md](../docs/diagram-standards.md) — Full style guide and legend
- [docs/architectural-views.md](../docs/architectural-views.md) — When to use each diagram type
...
- **Comprehensive guide**: `docs/diagram-standards.md` provides all conventions and examples
...
```
"Create a Mermaid diagram following devfoundry standards (see docs/diagram-standards.md).
...
- [ADR-0001: Frontend Stack](0001-frontend-stack.md) — Diagrams show React component trees
- [ADR-0002: Backend Stack](0002-backend-stack.md) — Diagrams show client/server interactions
- [docs/diagram-standards.md](../docs/diagram-standards.md) — Full specification
- [docs/architectural-views.md](../docs/architectural-views.md) — Framework for using diagrams
