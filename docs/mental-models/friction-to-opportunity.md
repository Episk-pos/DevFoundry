...
1. Notice friction (many people don't)
2. Analyze it (understand the underlying problem)
3. Evaluate it (is this worth solving?)
4. Act on it (test solutions small)
...
**Example**:
1. Why is scheduling meetings hard? → People use different calendars
2. Why do they use different calendars? → Different tools across organizations
3. Why don't they use a shared tool? → They're in different companies
4. Why does that matter? → No single system has visibility into all availability
5. Why hasn't this been solved? → Solutions exist but have adoption friction
...
Apply [Protocol Thinking](protocol-thinking.md):

1. **Who are the actors?**
2. **What are their boundaries and incentives?**
3. **Where does the protocol break?**
...
1. **Talk to people** — Do others have this problem? How do they solve it now?
2. **Manual solution** — Can you solve it by hand? (concierge MVP)
3. **Spreadsheet/doc** — Can you solve it with existing tools?
4. **Landing page** — Does anyone sign up for a solution?
5. **Minimal tool** — Can you build the simplest possible version?
6. **Iterate** — Does usage grow? Do people pay/refer?
...
1. Offer to manage tasks for 5 people
2. Use a spreadsheet and manual check-ins
3. Learn what they actually need
4. Discover edge cases and priorities
5. *Then* consider building software
...
**Friction noticed**: "Scheduling meetings across organizations is painful"

**Analysis**:
- Actors: Multiple people, different calendars, different orgs
- Protocol failure: No shared visibility into availability
- Existing solutions: Calendly (one-to-many), Doodle (polling) — gaps remain

**Evaluation**:
- Frequency: High (knowledge workers)
- Severity: Medium (annoying, not catastrophic)
- Population: Large (everyone with meetings)
- Willingness to pay: Medium (individuals less, enterprises more)
- Solvability: High (software is perfect for this)

**Action**: Built tools that integrate with multiple calendar systems, focusing on enterprise coordination needs.

### Case Study 2: Documentation

**Friction noticed**: "Our team's knowledge is scattered and hard to find"

**Analysis**:
- Actors: Team members, new hires, external collaborators
- Protocol failure: No system of record, informal sharing, search is broken
- Existing solutions: Wikis (hard to maintain), Docs (scattered), Notion (another tool)

**Evaluation**:
- High frequency, medium severity, large population, medium willingness, high solvability

**Action**: Started with manual curation for one team, learned what categories matter, built simple tool around those patterns.

### Case Study 3: Code Review

**Friction noticed**: "Code reviews take forever and block progress"

**Analysis**:
- Actors: Author, reviewers, codebase, CI system
- Protocol failure: Reviews are batched, async, not prioritized
- Existing solutions: GitHub/GitLab PRs (standard but slow)

**Evaluation**:
- Very high frequency (developers), medium severity, large population, high willingness (dev tools sell), high solvability

**Action**: AI-assisted review tools, automated checks, better notification and prioritization systems.
...
1. **Notice friction** — Pay attention to frustrations (yours and others')
2. **Analyze deeply** — Understand root causes, not just symptoms
3. **Evaluate honestly** — Not all friction is worth solving
4. **Act small** — Test before you build, build before you scale
5. **Practice continuously** — Build an idea pipeline, not a single bet

**Key insight**: Your unique perspective helps you notice friction that others miss. Software gives you leverage to build solutions. The combination is powerful.

---

## Next Steps

1. **Start a friction log** — Record frustrations for one week
2. **Pick one friction** — Apply the full analysis
3. **Talk to 5 people** — Validate that others experience it
4. **Try a manual solution** — Learn before you build
5. **Share what you learn** — Build in public

---

## Related

- [Protocol Thinking](protocol-thinking.md) — Analyzing systems and failures
- [The DevFoundry Thesis](../thesis.md) — Why software is accessible leverage
- [Flow-Based Development](flow-based-dev.md) — Building software with clarity
