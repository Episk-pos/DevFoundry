...
✅ **Better prompt**:
```
"In my lemonade stand app, totals are calculated in utils/pricing.js
by the calculateTotal function:
...
## Architecture-First for Learning
...
✅ **Architecture-first**:
```
"I'm reading the lemonade stand app. In App.jsx, I see:

[paste code snippet]

**Questions**:
1. In the module view, what files does this import from?
2. In the component-connector view, what's the data flow here?
3. What does `useState` do?
4. Why is `handleAddOrder` defined inside the component?"
```

**Result**: Targeted explanations that build understanding.
...
Rewrite it with architectural context. Include:
- System description
- Architectural view
- Constraints
- Behavioral requirements

### Exercise 2: Diagnose Failures

Think of a time an AI assistant generated code that didn't fit. What context was missing?

Rewrite the prompt with that context included.

### Exercise 3: Prompt for Learning

Pick a concept you don't understand (e.g., useEffect, API calls, CSS flexbox).

Write an architecture-first prompt that asks for:
- Explanation
- Example in your project's context
...
- [flow-based-dev.md](flow-based-dev.md) — Core philosophy
- [../architectural-views.md](../architectural-views.md) — View types
- [../../prompts/02-architecture-first.md](../../prompts/02-architecture-first.md) — Prompt templates
