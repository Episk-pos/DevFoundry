...
**Tip**: When you encounter an unfamiliar term in the curriculum, come here first.
...
A document explaining *why* an architectural decision was made. See [adr/README.md](../adr/README.md).
...
### Allocation View
An architectural view showing where code runs (browser vs server, infrastructure). See [architectural-views.md](architectural-views.md).
...
An architectural view showing runtime behavior and data flow. See [architectural-views.md](architectural-views.md).
...
### Module View
An architectural view showing static structure (files, dependencies). See [architectural-views.md](architectural-views.md).
...
- [architectural-views.md](architectural-views.md) — View types (Module, Component-Connector, Allocation)
- [mental-models/](mental-models/) — Conceptual frameworks
- [curriculum/](../curriculum/) — Where these terms are taught in context
...
**Tip**: Bookmark this page! You'll refer to it often as you learn.
