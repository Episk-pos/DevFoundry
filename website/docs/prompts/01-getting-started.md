...
description: "Your first prompts: what to know, what to try"
---
...
Code: `const [orders, setOrders] = useState([]);`
...
Once comfortable:
- [Architecture First](02-architecture-first) — Building features
- Debugging — Systematic debugging (to be created)
- Reading Code — Understanding larger codebases (to be created)
