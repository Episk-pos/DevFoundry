...
|----------|---------|-------------|
| [Getting Started](/docs/prompts/getting-started) | First-time AI assistant usage | Starting your journey |
| [Architecture First](/docs/prompts/architecture-first) | Building features | Adding functionality |
| [Debugging](/docs/prompts/debugging) | Fixing issues | Something doesn't work |
| [Reading Code](/docs/prompts/reading-code) | Understanding unfamiliar code | Exploring codebases |
| [Designing Features](/docs/prompts/designing-features) | Planning before coding | Starting a new feature |
| [Iterative Refinement](/docs/prompts/iterative-refinement) | Improving existing code | Refactoring, optimizing |
| [Build vs. Borrow](/docs/prompts/build-vs-borrow) | Evaluating whether to use existing solutions | New project setup, feature planning |

### Product Architecture Pack

For product-level decisions, use the [Product Architecture](/docs/prompts/product-architecture) prompt pack:

| Template | Purpose | When to Use |
|----------|---------|-------------|
| [Discovering Loops](/docs/prompts/product-architecture/discovering-loops) | Find your minimal user loop | Starting a product, reassessing direction |
| [Onboarding from Loop](/docs/prompts/product-architecture/onboarding-from-loop) | Design first-time experience | Building signup/onboarding flows |
| [UX from Loop](/docs/prompts/product-architecture/ux-from-loop) | Ground interface decisions | Making UI/UX choices |
| [Backend from Loop](/docs/prompts/product-architecture/backend-from-loop) | Design APIs and data models | Architecting server-side |
| [Infrastructure from Loop](/docs/prompts/product-architecture/infra-from-loop) | Deployment and operations | Setting up infrastructure |

These prompts help you apply the [Minimal User Loop](/docs/mental-models/minimal-user-loop) mental model to product design.
