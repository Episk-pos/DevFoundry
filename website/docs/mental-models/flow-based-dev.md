...
description: The core philosophy of DevFoundry
---
...
**Next**: See [Architecture-First Thinking](architecture-first) for how to apply this when prompting AI assistants.
...
- [Curriculum Overview](../overview) — Start learning
