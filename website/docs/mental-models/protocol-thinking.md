...
description: Seeing Systems as Interactions Between Actors
---
...
:::tip[Key insight]
The world is full of broken protocols. Your unique perspective helps you notice specific ones. Software gives you the leverage to fix them.
:::
...
- [Friction to Opportunity](friction-to-opportunity) — Turning noticed problems into solutions
- [Flow-Based Development](flow-based-dev) — Applying protocol thinking to software design
- [Architecture-First Thinking](architecture-first) — Using protocol thinking with AI assistants
