...
## Going Further: Customization and Advanced Tools

This section is **optional**. You don't need any of this to continue with the curriculum. But if you're curious about how developers customize their terminals, here's a roadmap.
...
1. **Not now** — if you're new to the terminal, focus on the basics in this module
