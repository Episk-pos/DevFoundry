...
- Completed [Module 02: Anatomy of Projects](02-anatomy-of-projects.md)
...
👉 [Module 04](04-developer-tools.md) *(Coming soon)*
...
- [Glossary](../../docs/glossary.md) — Web-specific terms
- [Diagram Standards](../../docs/diagram-standards.md) — Creating Mermaid diagrams
- [Lemonade CLI Example](../../examples/01-lemonade-cli/) — The CLI version we're adapting
