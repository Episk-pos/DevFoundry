...
👉 **Go to**: [examples/00-hello-world-console](../../examples/00-hello-world-console/)
...
Once you've completed Hello World, you're ready for:

👉 **Go to**: [examples/01-lemonade-cli](../../examples/01-lemonade-cli/)

*(Note: This example will be created in a future iteration of devfoundry)*
...
**Hint**: Your function will look like:
```javascript
...
**Questions to answer**:
1. What is the input?
2. What is the processing (formula)?
3. What is the output?
4. Draw the I/O/P flow
...
Use the [getting started prompt template](../../prompts/01-getting-started.md):
...
👉 [Module 02: Anatomy of Projects](02-anatomy-of-projects.md)
...
- [docs/glossary.md](../../docs/glossary.md) — Full vocabulary reference
- [docs/mental-models/flow-based-dev.md](../../docs/mental-models/flow-based-dev.md) — Core philosophy
- [examples/00-hello-world-console/](../../examples/00-hello-world-console/) — Your first program
...
Next: Learn about the landscape of software architectures in Module 02. 🚀
