...
The main [Types as Communication](../04-types-as-communication.md) module teaches type concepts using TypeScript. This page shows the same concepts in **Python** and **Go** for:
