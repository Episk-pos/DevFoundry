...
- Completed [Module 01: What Software Is](01-what-software-is.md)
- Completed [Lemonade CLI example](../../examples/01-lemonade-cli/)
...
Let's apply the three architectural views from the [Architectural Views](../../docs/architectural-views.md) document to understand projects:
...
These are documented in our [ADRs](../../adr/).
...
- [Glossary](../../docs/glossary.md) — Look up unfamiliar terms
- [Architectural Views](../../docs/architectural-views.md) — Deep dive on views
- [ADR: Frontend Stack](../../adr/0001-frontend-stack.md) — Why we chose React/TypeScript/Vite
- [ADR: Backend Stack](../../adr/0002-backend-stack.md) — Why we chose Node/Express
