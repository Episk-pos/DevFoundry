...
### Traditional Deployment (Module 15)
...
See the [19-chat-docker-compose example](../../examples/19-chat-docker-compose/) for the complete working setup.
...
- **Practice**: Work through the [Docker Compose example](../../examples/19-chat-docker-compose/) and the [Kubernetes example](../../examples/20-chat-kubernetes/) to get hands-on experience
